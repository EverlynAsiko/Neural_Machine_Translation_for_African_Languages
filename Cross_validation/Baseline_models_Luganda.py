...
def generating_BPE():
  ...
  os.system(' joeynmt/scripts/build_vocab.py train.bpe.$src train.bpe.$tgt --output_path vocab2.txt')
...
def run_model():
    ...
    data:
      ...
      lowercase: False
      max_sent_length: 100
      src_vocab: "{path}/vocab2.txt"
      trg_vocab: "{path}/vocab2.txt"
    ...
    os.system("cd joeynmt; python3 -m joeynmt test 'models/lgen2_reverse_transformer/config.yaml'")
...
for train, test in kfold.split(df_pp):
    ...
    fff   = open('joeynmt/models/lgen2_reverse_transformer/test.log', 'r')   
...
fff = open('result_luganda.txt', mode='w')
